(module
  ...
  (func $smallestSide (param $x i32) (param $y i32) (param $z i32) (result i32) (result i32)
      ...
      (i32.mul
        (i32.add
          (i32.add
            ...
            (i32.mul (local.get $x) (local.get $z))
          )
          (i32.mul (local.get $y) (local.get $z))
        )
        (i32.const 2)
      )
      (i32.mul
        (call $smallestSide  (local.get $x) (local.get $y) (local.get $z))
      )
    )
  )
